...
export const BallDisplay = ({
  ...
  return (
    <div className="flex gap-3 my-4 items-center">
      <p
        className={`h-10 w-10 bg-orange-400 flex items-center justify-center shrink-0 rounded-full border border-orange-100 text-white font-bold ${(extraType === "noball" && runs > 1) || (isWicket && runs > 0) ? "text-xs" : ""}`}
      >
