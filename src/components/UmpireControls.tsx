...
const TeamScore = ({ name, runs, wickets, overs }: TeamScoreProps) => (
...
export const UmpireControls = ({ name, runs, wickets, overs, trackScore }: TeamScoreProps & { trackScore: (score: TrackScoreProps) => void }) => {
    const runButtons = [0, 1, 2, 3, 4, 6];

    return (
        <div className="">
            <TeamScore name={name} runs={runs} wickets={wickets} overs={overs} />
